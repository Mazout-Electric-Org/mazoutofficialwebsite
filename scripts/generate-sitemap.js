...
const ENTRIES = [
  ...
  { path: "/robotic-actuators", priority: "0.9", changefreq: "weekly", lastmod: today },
  { path: "/shop", priority: "0.9", changefreq: "weekly", lastmod: today },
  { path: "/logistics", priority: "0.8", changefreq: "monthly", lastmod: today },
  { path: "/patrolling", priority: "0.8", changefreq: "monthly", lastmod: today },
  { path: "/taxi", priority: "0.8", changefreq: "monthly", lastmod: today },
